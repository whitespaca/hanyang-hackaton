import { COLLECTION_SPOT_TYPE_METADATA, GARBAGE_CLASSES, GARBAGE_LABELS, formatConfidence, type ClassificationPrediction, type DisposalItem, type GarbageClass } from "@bunrishot/shared";
